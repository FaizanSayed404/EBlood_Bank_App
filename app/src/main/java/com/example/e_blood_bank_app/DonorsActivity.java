...
import com.example.e_blood_bank_app.Adapter.DonorsRecyclerAdapater;
...
public class DonorsActivity extends AppCompatActivity {
    ...
    DonorsRecyclerAdapater adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new DonorsRecyclerAdapater();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    DonorModel donorModel = snapshot1.getValue(DonorModel.class);
                    donorModelList.add(donorModel);
                }
                adapter.setDonorsModelList(donorModelList);
